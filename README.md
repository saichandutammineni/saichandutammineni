...
Previously built distributed systems at Betterplace and HashedIn by Deloitte. Interested in backend engineering, distributed systems, cloud infrastructure, and AI/ML systems.

🔭 Currently
Exploring LLM inference optimization and distributed systems
Building projects around AI infrastructure and scalable backend services

🛠 Tech Stack
Languages: Java, Python, C++, TypeScript, SQL
Backend: Spring Boot, FastAPI, Kafka, RabbitMQ, Microservices
Cloud & DevOps: AWS, Docker, Kubernetes, Terraform, GitHub Actions
AI/ML: PyTorch, LangChain, RAG, Hugging Face, TensorFlow
